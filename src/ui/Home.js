			...
			<div className="container">
				...
				<div className="row">
					<div className="twelve columns">
						...
						<h4>About</h4>
						<p>
							Notica was written by <a href="http://tanner.vc" target="_blank">Tanner</a> after he got tired of checking if his commands were done running.
						</p>
						<p>
							Notica <strike>is</strike> <i>will be, once it's done,</i> free and open-source software: <a href="https://github.com/tanner37/Notica" target="_blank">https://github.com/tanner37/Notica</a>
						</p>
						<p>
